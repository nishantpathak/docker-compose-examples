...
**BEWARE** : since the first publication of this Docker Compose example, Trivy which is used to generate the SBOM and is included in the Docker Compose to be used as a vulnerabilities scanner has been compromised by several attacks (ont his topic see https://socket.dev/blog/trivy-under-attack-again-github-actions-compromise or https://labs.boostsecurity.io/articles/20-days-later-trivy-compromise-act-ii/ for example). 
